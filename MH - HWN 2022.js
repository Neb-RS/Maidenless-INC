...
// @author       Leppy & in59te & Warden Slayer
...
function colorize() {
  ...
  document.querySelectorAll(".treasureMapView-goals-group-goal").forEach(el => {
    ...
    if (standardMice.indexOf(mouseName) > -1) {
      ...
      if (el.className.indexOf(" complete ") < 0) {
        stdCount++;
        addAr(el, mouseName, standardMice, standardMiceAr);
      } else {
      ...
      if (el.className.indexOf(" complete ") < 0) {
        jackoCount++;
        addAr(el, mouseName, jackoMice, jackoMiceAr);
      } else {
        if (isChecked) el.style.backgroundColor = "white";
      }
      ...
      if (el.className.indexOf(" complete ") < 0) {
        boneCount++;
        addAr(el, mouseName, boneMice, boneMiceAr);
      } else {
        if (isChecked) el.style.backgroundColor = "white";
      }
      ...
      if (el.className.indexOf(" complete ") < 0) {
        screamCount++;
        addAr(el, mouseName, screamMice, screamMiceAr);
      } else {
        if (isChecked) el.style.backgroundColor = "white";
      }
      ...
      if (el.className.indexOf(" complete ") < 0) {
        pgCount++;
        addAr(el, mouseName, pgMice, pgMiceAr);
      } else {
        if (isChecked) el.style.backgroundColor = "white";
      }
    }
  ...
  stdSpan.innerHTML = "Std (40)<br>" + stdCount;
  ...
  jackoSpan.innerHTML = "Jack (40)<br>" + jackoCount;
  ...
  screamSpan.innerHTML = "Scream (45)<br>" + screamCount;
